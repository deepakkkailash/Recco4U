...
const InputComponent = (props)=>{
    ...
    if(props.formcomponent.answer){
        ...
        return(
        <input  type={!props.seepassword?props.formcomponent.type:'text'} name={props.formcomponent.name} onChange={props.formcomponent.onChange} placeholder={props.placeholder} className='p-[10px] w-[90%] rounded-lg h-fit bg-gray-700 font-bold text-white hover:bg-gray-600 focus:bg-black' />)
    }
    else{
