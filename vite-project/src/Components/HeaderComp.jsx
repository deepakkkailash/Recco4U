...
const HeaderComp = (props)=>{
            ...
            <div className=' mt-2 flex flex-row  items-center justify-around w-[100vw]'>
                ...
                <InputComponent formcomponent={{answer:false}} placeholder='Search For Anything' whattosearch={props.whattosearch} wheretosearch={props.wheretosearch} changeWhat={props.changeWhat} changeWhere={props.changeWhere}/>
